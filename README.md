...
```sh
  cd my-folder
  git clone https://github.com/fuadmoin/past-project
```
...
If you like this project feel free to write a review.

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 🙏 Acknowledgments <a name="acknowledgements"></a>

The html and css files are taken from the Microverse trails that I built it with my pair programming partner @M-badox.
